...
<?php $__env->startSection('content'); ?>
		...
		<div class="container-fluid">
			...
			<?php endif; ?>
			<?php if(Myhelper::hasRole(["mis"])): ?>
			    <div class="row">
			        <div class="col-xl-6">
			            <div class="card">
				            <div class="card-header border-0 pb-0">
				                <h2 class="card-title fs-24">Hello <?php echo e(explode(' ',ucwords(Auth::user()->name))[0]); ?><br><span style="color:var(--primary);" class="fs-18">Welcome Back!</span></h2>
				            </div>
				            <div class="card-body pb-0">
				                <ul class="list-group list-group-flush">
			                ...
			                <div class="card-body mb-3">
                                ...
                                <div class="select-text-wrap">
                                    ...
                                    <div class="text-select-copy border border-secondary border-opacity-10 px-3 py-2 rounded mb-3 text-primary">
                                        https://login.mdrpay.com/register?reseller_id=<?php echo e(explode(' ', ucwords(Auth::user()->id))[0]); ?>
