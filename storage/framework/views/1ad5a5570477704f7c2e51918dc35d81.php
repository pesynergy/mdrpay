                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <ul class="list list-unstyled">
                                            <li><span class="text-semibold"><?php echo e($bank->ifsc); ?></span></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <ul class="list list-unstyled text-right">
                                            <li><span class="text-semibold"><?php echo e($bank->branch); ?></span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        var url = "<?php echo e(url('statement/list/fetch')); ?>/fundrequest/0";
        var onDraw = function() {};
        var options = [
            { "data" : "id"},
            { "data" : "id",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u564371677/domains/dashboard.nanakpay.com/public_html/new2/resources/views/fund/request.blade.php ENDPATH**/ ?>