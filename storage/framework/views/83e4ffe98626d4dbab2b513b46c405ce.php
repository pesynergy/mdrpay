    ...
    <div class="page-header mb-10">
        <div class="page-header-content">
            <div class="page-title">
                <div class="row">
                    <h5 class="col-md-3"><span class="text-semibold">Apna Money</span> - <?php echo $__env->yieldContent('pagetitle'); ?></h5>
...
</div><!-- /.modal --><?php /**PATH /home/u564371677/domains/dashboard.nanakpay.com/public_html/newui/resources/views/layouts/pageheader.blade.php ENDPATH**/ ?>