                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="heading-elements">
                            <button type="submit" class="btn btn-info btn-xs btn-labeled legitRipple" onclick="addSetup()"q data-loading-text="<b><i class='fa fa-spin fa-spinner'></i></b> Searching"><b><i class="icon-search4"></i></b> Add New</button></div>
                    </div>
                    <div class="card-body">
        ...
        var options = [
            ...
            { "data" : "id",
                render:function(data, type, full, meta){
                    ...
                    var out =  `<button type="button" class="btn btn-info btn-raised legitRipple btn-xs" onclick="editSetup(this)">Edit</button>
                                <button type="button" class="btn btn-info btn-raised legitRipple btn-xs" onclick="viewCommission(`+full.id+`, '`+full.name+`')"> View Commission</button>
                                <div class="btn-group btn-group-fade">
                                    <button type="button" class="btn btn-info btn-raised legitRipple btn-xs" data-toggle="dropdown" aria-expanded="false">Commission/Charge <span class="caret"></span></button>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u564371677/domains/dashboard.nanakpay.com/public_html/new1/resources/views/resource/scheme.blade.php ENDPATH**/ ?>