		...
		<ul class="metismenu" id="menu">
    			...
    			<li>
    				...
    				<ul aria-expanded="false">
        				...
        				<?php if(Myhelper::can(['view_apiuser'])): ?>
        				    <li><a href="<?php echo e(route('member', ['type' => 'apiuser'])); ?>">Merchant/ API User</a></li>
        				<?php endif; ?>
        				<?php if(Myhelper::can(['view_mis'])): ?>
        				    <li><a href="<?php echo e(route('member', ['type' => 'mis'])); ?>">Reseller User</a></li>
        				<?php endif; ?>
    				</ul>
    			</li>
			<?php endif; ?>
                ...
                <li>
                    ...
                    <ul aria-expanded="false">
                        <?php if(Myhelper::can(['view_kycpending'])): ?>
                            <li><a href="<?php echo e(route('member', ['type' => 'kycpending'])); ?>">Pending Kyc</a></li>
                        <?php endif; ?>
                        <?php if(Myhelper::can(['view_kycsubmitted'])): ?>
                            <li><a href="<?php echo e(route('member', ['type' => 'kycsubmitted'])); ?>">Submitted Kyc</a></li>
                        <?php endif; ?>
                        <?php if(Myhelper::can(['view_kycrejected'])): ?>
                            <li><a href="<?php echo e(route('member', ['type' => 'kycrejected'])); ?>">Rejected Kyc</a></li>
                        <?php endif; ?>
                    </ul>
                </li>
            <?php endif; ?>
            ...
            <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false" style="font-size: 14px;">
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="<?php echo e(route('setup', ['type' => 'apitoken'])); ?>">Api Token</a></li>
                    <?php endif; ?>
                </ul>
            </li>
            <?php endif; ?>
			...
			<li><a class="has-arrow ai-icon" href="javascript:void(0);" aria-expanded="false">
				...
				<ul aria-expanded="false">
					<li><a href="<?php echo e(route('reports', ['type' => 'mainwallet'])); ?>">Collection Wallet</a></li>
...
</div><?php /**PATH /home/u690537273/domains/login.mdrpay.com/public_html/resources/views/layouts/newsidebar.blade.php ENDPATH**/ ?>