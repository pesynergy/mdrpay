    ...
    <div class="navbar-collapse collapse" id="navbar-second-toggle">
        <ul class="nav navbar-nav navbar-nav-material">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu width-250">
                        <?php if(Myhelper::can('company_manager')): ?>
                            <li><a href="<?php echo e(route('resource', ['type' => 'company'])); ?>"><i class="icon-arrow-right5"></i> Company Manager</a></li>
                        <?php endif; ?>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu width-250">
                        <?php if(Myhelper::can(['view_subamdin'])): ?>
                            <li><a href="<?php echo e(route('member', ['type' => 'subadmin'])); ?>"><i class="icon-arrow-right5"></i> Admin</a></li>
                        <?php endif; ?>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu width-250">
                    <?php if(Myhelper::can('collection_statement')): ?>
                        ...
                        <li><a href="<?php echo e(route('reports', ['type' => 'payin'])); ?>"><i class="icon-arrow-right5"></i> Collection</a></li>
                    <?php endif; ?>

                    <?php if(Myhelper::can('payout_statement')): ?>
                        <li><a href="<?php echo e(route('reports', ['type' => 'payout'])); ?>"><i class="icon-arrow-right5"></i> Payout</a></li>
                    <?php endif; ?>
                    
                    <?php if(Myhelper::can('qr_statement')): ?>
                        <li><a href="<?php echo e(route('reports', ['type' => 'upiintent'])); ?>"><i class="icon-arrow-right5"></i> Intent</a></li>
                    <?php endif; ?>
                </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu width-250">
                    <li><a href="<?php echo e(route('reports', ['type' => 'mainwallet'])); ?>"><i class="icon-arrow-right5"></i> Collection Wallet</a></li>
...
</div><?php /**PATH /home/u564371677/domains/dashboard.nanakpay.com/public_html/resources/views/layouts/newsidebar.blade.php ENDPATH**/ ?>