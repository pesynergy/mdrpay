<?php $__env->startSection('title', "Complete Profile"); ?>
...
<div class="content">
    <form class="memberForm" action="<?php echo e(route('profileUpdate')); ?>" method="post">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h5 class="panel-title">Company Documents</h5>
                    </div>
                    <div class="panel-body p-b-0">
                        <div class="row">
                            <div class="form-group col-md-4">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u564371677/domains/dashboard.nanakpay.com/public_html/new1/resources/views/profile/completeKyc.blade.php ENDPATH**/ ?>