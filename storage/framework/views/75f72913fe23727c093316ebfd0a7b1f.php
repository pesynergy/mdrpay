...
<script type="text/javascript">
    $(document).ready(function () {
        var url = "<?php echo e(url('statement/list/fetch')); ?>/complaints/0";
        var onDraw = function() {
        };
        var options = [
            { "data" : "name",
    ...
    function viewData(id){
        $.ajax({
            url: `<?php echo e(url('statement/list/fetch')); ?>/getstatement/`+id+`/single`,
            type: 'post',
            headers: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u564371677/domains/dashboard.nanakpay.com/public_html/new2/resources/views/complaint.blade.php ENDPATH**/ ?>