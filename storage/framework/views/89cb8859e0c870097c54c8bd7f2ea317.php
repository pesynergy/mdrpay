<?php $__env->startSection('title', ucwords($type)." Transaction History"); ?>
<?php $__env->startSection('pagetitle', ucwords($type)." Transaction History"); ?>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title"><?php echo e($type); ?> Transaction History</h4>
                    </div>
                    <div class="card-body">
            ...
            var options = [
                ...
                { "data" : "status",
                    render:function(data, type, full, meta){
                        ...
                        <?php if(in_array($type , ["payin", "payout"]) && Myhelper::can(["payout_statement_edit", "upi_statement_edit"])): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u690537273/domains/login.mdrpay.com/public_html/resources/views/statement/transaction.blade.php ENDPATH**/ ?>