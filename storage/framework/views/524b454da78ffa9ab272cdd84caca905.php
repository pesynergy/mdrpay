                ...
                render:function(data, type, full, meta){
                    var menu = ``;
                        menu += `<li class="dropdown-header">Setting</li>
                                <li style="padding-left:15px;"><a href="javascript:void(0)" onclick="editSetup('`+full.id+`', '`+full.companyname+`', '`+full.website+`', '`+full.senderid+`', '`+full.smsuser+`', '`+full.smspwd+`')"><i class="fas fa-pencil-alt" style="padding-right:8px;"></i> Edit</a></li>`;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u564371677/domains/dashboard.nanakpay.com/public_html/new3/resources/views/resource/company.blade.php ENDPATH**/ ?>