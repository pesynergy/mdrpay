...
<?php $__env->startPush('script'); ?>
    ...
    $(document).ready(function () {
        ...
        var options = [
            ...
            { "data" : "id",
                render:function(data, type, full, meta){
                    return `<button type="button" class="btn bg-slate btn-raised legitRipple btn-xs editOperator" > Edit</button>`;
                }
            },
        ];
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u564371677/domains/dashboard.nanakpay.com/public_html/resources/views/setup/operator.blade.php ENDPATH**/ ?>