            ...
            { "data" : "id",
                render:function(data, type, full, meta){
                    var menu = ``;
                        ...
                        <?php $__currentLoopData = $charge; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        menu += `<li style="padding-left:15px;padding-bottom:10px;text-transform:capitalize;"><a href="javascript:void(0)" onclick="commission(`+full.id+`, '<?php echo e($key); ?>','<?php echo e($key); ?>Modal')"><i class="fa fa-inr"></i> <?php echo e($key); ?> Charge</a></li>`;
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u564371677/domains/dashboard.nanakpay.com/public_html/neww/resources/views/resource/scheme.blade.php ENDPATH**/ ?>