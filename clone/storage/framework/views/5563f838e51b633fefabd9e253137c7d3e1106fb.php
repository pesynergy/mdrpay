        ...
        <div class="row">
            <div class="col-md-8">
                <?php if(Myhelper::hasRole(["admin"])): ?>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="panel border-top-danger border-top-xlg">
                                <div class="panel-body text-center">
                                    <div class="content-group mt-5">
                                        <i class="icon-wallet icon-3x"></i>
                                    </div>

                                    <h6 class="text-semibold"><a href="#" class="text-default">Wallet Balance</a></h6>
                        ...
                        <div class="col-md-3">
                            <div class="panel border-top-primary border-top-xlg">
                                <div class="panel-body text-center">
                                    <div class="content-group mt-5">
                                        <i class="icon-wallet icon-3x"></i>
                                    </div>

                                    <h6 class="text-semibold"><a href="#" class="text-default">Downline Balance</a></h6>
                        ...
                        <div class="col-md-3">
                            <div class="panel border-top-violet border-top-xlg">
                                <div class="panel-body text-center">
                                    <div class="content-group mt-5">
                                        <i class="icon-wallet icon-3x"></i>
                                    </div>

                                    <h6 class="text-semibold"><a href="#" class="text-default">Today Pay-In</a></h6>
                        ...
                        <div class="col-md-3">
                            <div class="panel border-top-indigo border-top-xlg">
                                <div class="panel-body text-center">
                                    <div class="content-group mt-5">
                                        <i class="icon-wallet icon-3x"></i>
                                    </div>

                                    <h6 class="text-semibold"><a href="#" class="text-default">Today Pay-Out</a></h6>
            ...
            <div class="col-md-4">
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h6 class="panel-title">Recent Transaction</h6>
                    </div>
