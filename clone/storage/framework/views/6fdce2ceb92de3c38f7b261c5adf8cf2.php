                            ...
                            <div class="col-xl-3 col-lg-4" style="background-color:var(--card)">
                                <div class="p-5">
									<div class="author-profile">
									    <img src="https://mdrpay.com/images/MDR-Logo.png" alt="" width="100%">
										<!--<div class="author-media">-->
										<!--	<img src="<?php echo e(asset('')); ?>new_assests/images/tab/1.jpg" alt="">-->
                                ...
                                <div class="nav flex-column nav-pills mb-3">
                                    <a href="#v-pills-home" data-bs-toggle="pill" class="nav-link active show"><strong>Company Details</strong></a>
                                    <a href="#v-pills-profile" data-bs-toggle="pill" class="nav-link"><strong>Company Logo</strong></a>
                                    <a href="#v-pills-messages" data-bs-toggle="pill" class="nav-link"><strong>Company News</strong></a>
                                    <a href="#v-pills-settings" data-bs-toggle="pill" class="nav-link"><strong>Company Support Details</strong></a>
                                </div>
                            </div>
                            <div class="col-xl-9 col-lg-8">
                                <div class="tab-content" style="background-color:var(--card); padding-bottom:50px;">
                                    <div id="v-pills-home" class="tab-pane fade active show">
                                        ...
                                        <form id="profileForm" action="<?php echo e(route('resourceupdate')); ?>" method="post" style="padding:20px">
                                    ...
                                    <div id="v-pills-profile" class="tab-pane fade">
                                        ...
                                        <form class="dropzone" id="logoupload" action="<?php echo e(route('resourceupdate')); ?>" method="post" enctype="multipart/form-data" style="padding:20px">
                                            <?php echo e(csrf_field()); ?>
                                    ...
                                    <div id="v-pills-messages" class="tab-pane fade">
                                        ...
                                        <form id="newsForm" action="<?php echo e(route('resourceupdate')); ?>" method="post" style="padding:20px">
                                            <?php echo e(csrf_field()); ?>
                                    ...
                                    <div id="v-pills-settings" class="tab-pane fade">
                                        <div class="card-header">
                                         ...
                                         <form id="supportForm" action="<?php echo e(route('resourceupdate')); ?>" method="post" style="padding:20px">
                                            <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u690537273/domains/login.mdrpay.com/public_html/clone/resources/views/resource/companyprofile.blade.php ENDPATH**/ ?>