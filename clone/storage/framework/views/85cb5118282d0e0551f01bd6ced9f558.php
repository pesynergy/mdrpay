            ...
            <div class="page-header mb-10">
                <div class="form-head mb-4">
                    <div class="page-title">
                        <div class="row">
                            <h2 class="text-black font-w600 mb-0"><span class="text-semibold">NanakPay</span> - <?php echo $__env->yieldContent('pagetitle'); ?></h2>
                    ...
                    <form id="searchForm">
                        <div class="card-header">
                            ...
                            <div class="heading-elements">
                                <button type="submit" class="btn btn-info btn-xs btn-labeled legitRipple" data-loading-text="<b><i class='fa fa-spin fa-spinner'></i></b> Searching"><b><i class="icon-search4"></i></b> Search</button>
                                ...
                                <button type="button" class="btn btn-primary btn-xs btn-labeled legitRipple <?php echo e(isset($export) ? '' : 'hide'); ?>" product="<?php echo e($export ?? ''); ?>" id="reportExport"><b><i class="icon-cloud-download2"></i></b> Export</button>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="row">
...
</div><?php /**PATH /home/u564371677/domains/dashboard.nanakpay.com/public_html/new1/resources/views/layouts/pageheader.blade.php ENDPATH**/ ?>