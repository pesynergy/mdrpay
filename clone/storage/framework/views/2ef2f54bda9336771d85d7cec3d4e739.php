			    ...
			    <div class="row  mb-4">
                    <div class="col-xl-3">
                        <div class="card-bx mb-0">
                            <img src="<?php echo e(asset('new_assests/images/card3-DiULJuRe.jpg')); ?>" alt="">
                            <div class="card-info text-white">
                                <p class="mb-1 text-white"><strong>Total Deposit</strong></p>
					...
					<div class="col-xl-3">
                        <div class="card-bx mb-0">
                            <img src="<?php echo e(asset('new_assests/images/card2-NRj3firC.jpg')); ?>" alt="">
                            <div class="card-info text-white">
                                <p class="mb-1 text-white"><strong>Total Withdrawal</strong></p>
                                <h2 class="fs-36 text-white mb-sm-4 mb-3">$23,511</h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3">
                        <div class="card-bx mb-0">
                            <img src="<?php echo e(asset('new_assests/images/card/card2.png')); ?>" alt="">
                            <div class="card-info text-white">
                                <p class="mb-1 text-white"><strong>Total Refund</strong></p>
                                <h2 class="fs-36 text-white mb-sm-4 mb-3">$23,511</h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3">
                        <div class="card-bx mb-0">
                            <img src="<?php echo e(asset('new_assests/images/card/card4.png')); ?>" alt="">
                            <div class="card-info text-white">
                                <p class="mb-1 text-white"><strong>Total Chargeback</strong></p>
                                <h2 class="fs-36 text-white mb-sm-4 mb-3">$23,511</h2>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u690537273/domains/login.mdrpay.com/public_html/resources/views/home.blade.php ENDPATH**/ ?>