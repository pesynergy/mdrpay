...
<head>
    ...
    <!-- [Favicon] icon -->
    <link rel="icon" href="{{ asset('') }}new_assests/images/favicon.svg" type="image/x-icon" />
    <!-- map-vector css -->
    <link rel="stylesheet" href="{{ asset('') }}new_assests/css/plugins/jsvectormap.min.css" />
    <!-- [Google Font : Public Sans] icon -->
    <link href="https://fonts.googleapis.com/css2?family=Public+Sans:wght@400;500;600;700&amp;display=swap" rel="stylesheet" />
    <!-- [phosphor Icons] https://phosphoricons.com/ -->
    <link rel="stylesheet" href="{{ asset('') }}new_assests/fonts/phosphor/duotone/style.css" />
    <!-- [Tabler Icons] https://tablericons.com -->
    <link rel="stylesheet" href="{{ asset('') }}new_assests/fonts/tabler-icons.min.css" />
    <!-- [Feather Icons] https://feathericons.com -->
    <link rel="stylesheet" href="{{ asset('') }}new_assests/fonts/feather.css" />
    <!-- [Font Awesome Icons] https://fontawesome.com/icons -->
    <link rel="stylesheet" href="{{ asset('') }}new_assests/fonts/fontawesome.css" />
    <!-- [Material Icons] https://fonts.google.com/icons -->
    <link rel="stylesheet" href="{{ asset('') }}new_assests/fonts/material.css" />
    <!-- [Template CSS Files] -->
    <link rel="stylesheet" href="{{ asset('') }}new_assests/css/style.css" id="main-style-link" />
    <link rel="stylesheet" href="{{ asset('') }}new_assests/css/style-preset.css" />
...
<body data-pc-preset="preset-1" data-pc-sidebar-theme="light" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme="light">
    ...
    <!--<script src="{{ asset('') }}new_assests/js/plugins/apexcharts.min.js"></script>-->
    <!--<script src="{{ asset('') }}new_assests/js/plugins/jsvectormap.min.js"></script>-->
    <!--<script src="{{ asset('') }}new_assests/js/plugins/world.js"></script>-->
    <!--<script src="{{ asset('') }}new_assests/js/plugins/world-merc.js"></script>-->
    <!--<script src="{{ asset('') }}new_assests/js/widgets/earnings-users-chart.js"></script>-->
    <!--<script src="{{ asset('') }}new_assests/js/widgets/world-map-markers.js"></script>-->
    <!--  -->
    <!-- [Page Specific JS] end -->
    <!-- Required Js -->
    <script src="{{ asset('') }}new_assests/js/plugins/popper.min.js"></script>
    <script src="{{ asset('') }}new_assests/js/plugins/simplebar.min.js"></script>
    <script src="{{ asset('') }}new_assests/js/plugins/bootstrap.min.js"></script>
    <script src="{{ asset('') }}new_assests/js/plugins/i18next.min.js"></script>
    <script src="{{ asset('') }}new_assests/js/plugins/i18nextHttpBackend.min.js"></script>
    <script src="{{ asset('') }}new_assests/js/icon/custom-font.js"></script>
    <script src="{{ asset('') }}new_assests/js/script.js"></script>
    <script src="{{ asset('') }}new_assests/js/theme.js"></script>
    <script src="{{ asset('') }}new_assests/js/multi-lang.js"></script>
    <script src="{{ asset('') }}new_assests/js/plugins/feather.min.js"></script>
