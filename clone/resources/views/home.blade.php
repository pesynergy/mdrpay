			    ...
			    <div class="row  mb-4">
    			    <div class="col-md-3 col-sm-6">
                        <div class="card statistics-card-1 overflow-hidden">
                            <div class="card-body">
                                <img src="{{asset('')}}new_assests/images/widget/img-status-4.svg" alt="img" class="img-fluid img-bg" />
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="card statistics-card-1 overflow-hidden bg-brand-color-3">
                            <div class="card-body">
                                <img src="{{asset('')}}new_assests/images/widget/img-status-6.svg" alt="img" class="img-fluid img-bg" />
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="card statistics-card-1 overflow-hidden">
                            <div class="card-body">
                                <img src="{{asset('')}}new_assests/images/widget/img-status-5.svg" alt="img" class="img-fluid img-bg" />
								...
								<div class="card">
									<div class="card-header flex-wrap border-0 pb-0">
										<div class="me-3 mb-2">
											...
											<span class="fs-24 text-black font-w600">$ {{Auth::user()->payoutwallet}}</span>
										</div>
									</div>
									<div class="card-body p-0">
