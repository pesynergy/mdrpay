    ...
    <div class="login-account">
        <div class="row h-100">
            ...
            <div class="col-lg-4 align-self-start">
                <div class="text-center mb-4"><img src="https://mdrpay.com/images/MDR-Logo.png" alt="{{ $title }}" width="250"></div>
                <div class="account-info-area" style="background-image: url('{{ asset('new_assests/images/rainbow.gif') }}'); max-height:200px;">
