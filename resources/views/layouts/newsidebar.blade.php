    			...
    			<li>
    				...
    				<ul aria-expanded="false">
        				...
        				@if (Myhelper::can(['view_apiuser']))
        				    <li><a href="{{route('member', ['type' => 'apiuser'])}}">Merchant/ API User</a></li>
        				@endif
        				@if (Myhelper::can(['view_mis']))
        				    <li><a href="{{route('member', ['type' => 'mis'])}}">Reseller User</a></li>
        				@endif
    				</ul>
    			</li>
			@endif
                ...
                <li>
                    ...
                    <ul aria-expanded="false">
                        @if (Myhelper::can(['view_kycpending']))
                            <li><a href="{{route('member', ['type' => 'kycpending'])}}">Pending Kyc</a></li>
                        @endif
                        @if (Myhelper::can(['view_kycsubmitted']))
                            <li><a href="{{route('member', ['type' => 'kycsubmitted'])}}">Submitted Kyc</a></li>
                        @endif
                        @if (Myhelper::can(['view_kycrejected']))
                            <li><a href="{{route('member', ['type' => 'kycrejected'])}}">Rejected Kyc</a></li>
                        @endif
                    </ul>
                </li>
            @endif
